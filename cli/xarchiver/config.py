...
class Settings(BaseSettings):
    ...
    source_scan_sleep_min_seconds: float = Field(default=2.0, alias="SOURCE_SCAN_SLEEP_MIN_SECONDS")
    source_scan_sleep_max_seconds: float = Field(default=6.0, alias="SOURCE_SCAN_SLEEP_MAX_SECONDS")
